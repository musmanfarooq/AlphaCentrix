...
$.extend(IslamicCalendar.prototype, {
	...
	regional: { // Localisations
		'': {
		    name: 'Hijri', // The calendar name
			epochs: ['BH', 'AH'],
			monthNames: ['محرم', 'صفر', 'ربيع الأول', 'ربيع الثاني', 'جمادى الأول', 'جمادى الثاني',
			'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
			monthNamesShort: ['مح', 'صف', 'ربيع1', 'ربيع2', 'جمادى1', 'جمادى2', 'رج', 'شع', 'رم', 'ش', 'ذو قع', 'ذو حج'],
			dayNames: ['يوم الأحد', 'يوم الأثنين', 'يوم الثلاثاء',
			'يوم الأربعاء\'', 'يوم الخميس', 'يوم الجمعة', 'يوم السبت'],
			dayNamesShort: ['أح', 'إث', 'ث', 'أر', 'خ', 'ج', 'س'],
...
$.calendars.calendars.hijri = IslamicCalendar;
